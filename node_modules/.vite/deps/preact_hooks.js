...
function x() {
  ...
  for (i.sort(f); n2 = i.shift(); )
    n2.__d && (u3 = i.length, o3 = void 0, e3 = (r3 = (t3 = n2).__v).__e, s3 = [], a3 = [], (c3 = t3.__P) && ((o3 = v({}, r3)).__v = r3.__v + 1, l.vnode && l.vnode(o3), F(c3, o3, r3, t3.__n, void 0 !== c3.ownerSVGElement, 32 & r3.__u ? [e3] : null, s3, null == e3 ? m(r3) : e3, !!(32 & r3.__u), a3), o3.__v = r3.__v, o3.__.__k[o3.__i] = o3, L(s3, o3, a3), o3.__e != e3 && w(o3)), i.length > u3 && i.sort(f));
  x.__r = 0;
}
...
function T(n2, l3, u3, t3, i3) {
  ...
  n:
    if ("style" === l3)
      ...
      o3 = l3 !== (l3 = l3.replace(/(PointerCapture)$|Capture$/i, "$1")), l3 = l3.toLowerCase() in n2 || "onFocusOut" === l3 || "onFocusIn" === l3 ? l3.toLowerCase().slice(2) : l3.slice(2), n2.l || (n2.l = {}), n2.l[l3 + o3] = u3, u3 ? t3 ? u3.u = t3.u : (u3.u = Date.now(), n2.addEventListener(l3, o3 ? D : A, o3)) : n2.removeEventListener(l3, o3 ? D : A, o3);
    else {
      if (i3)
...
function F(n2, u3, t3, i3, o3, r3, f3, e3, c3, s3) {
  var a3, p3, y2, d3, _2, m3, w3, k3, x3, P3, S2, $, I2, H2, T3, A3 = u3.type;
  ...
  n:
    if ("function" == typeof A3)
      try {
        ...
        if (p3.context = P3, p3.props = k3, p3.__P = n2, p3.__e = false, $ = l.__r, I2 = 0, "prototype" in A3 && A3.prototype.render) {
          for (p3.state = p3.__s, p3.__d = false, $ && $(u3), a3 = p3.render(p3.props, p3.state, p3.context), H2 = 0; H2 < p3._sb.length; H2++)
        ...
        p3.state = p3.__s, null != p3.getChildContext && (i3 = v(v({}, i3), p3.getChildContext())), y2 || null == p3.getSnapshotBeforeUpdate || (m3 = p3.getSnapshotBeforeUpdate(d3, _2)), C(n2, h(T3 = null != a3 && a3.type === g && null == a3.key ? a3.props.children : a3) ? T3 : [T3], u3, t3, i3, o3, r3, f3, e3, c3, s3), p3.base = u3.__e, u3.__u &= -161, p3.__h.length && f3.push(p3), w3 && (p3.__E = p3.__ = null);
      } catch (n3) {
...
function M(l3, u3, t3, i3, o3, r3, f3, e3, s3) {
  var a3, v3, y2, d3, _2, g3, b3, w3 = t3.props, k3 = u3.props, x3 = u3.type;
  if ("svg" === x3 && (o3 = true), null != r3) {
    for (a3 = 0; a3 < r3.length; a3++)
      if ((_2 = r3[a3]) && "setAttribute" in _2 == !!x3 && (x3 ? _2.localName === x3 : 3 === _2.nodeType)) {
        l3 = _2, r3[a3] = null;
        break;
      }
  }
  if (null == l3) {
    ...
    l3 = o3 ? document.createElementNS("http://www.w3.org/2000/svg", x3) : document.createElement(x3, k3.is && k3), r3 = null, e3 = false;
  }
  if (null === x3)
    ...
    if (r3 = r3 && n.call(l3.childNodes), w3 = t3.props || c, !e3 && null != r3)
      for (w3 = {}, a3 = 0; a3 < l3.attributes.length; a3++)
        w3[(_2 = l3.attributes[a3]).name] = _2.value;
    for (a3 in w3)
      _2 = w3[a3], "children" == a3 || ("dangerouslySetInnerHTML" == a3 ? y2 = _2 : "key" === a3 || a3 in k3 || T(l3, a3, null, _2, o3));
    for (a3 in k3)
      _2 = k3[a3], "children" == a3 ? d3 = _2 : "dangerouslySetInnerHTML" == a3 ? v3 = _2 : "value" == a3 ? g3 = _2 : "checked" == a3 ? b3 = _2 : "key" === a3 || e3 && "function" != typeof _2 || w3[a3] === _2 || T(l3, a3, _2, w3[a3], o3);
    if (v3)
      e3 || y2 && (v3.__html === y2.__html || v3.__html === l3.innerHTML) || (l3.innerHTML = v3.__html), u3.__k = [];
    else if (y2 && (l3.innerHTML = ""), C(l3, h(d3) ? d3 : [d3], u3, t3, i3, o3 && "foreignObject" !== x3, r3, f3, r3 ? r3[0] : t3.__k && m(t3, 0), e3, s3), null != r3)
      for (a3 = r3.length; a3--; )
        null != r3[a3] && p(r3[a3]);
...
function j(n2, u3, t3) {
  ...
  if (i3 = n2.__k)
    for (o3 = 0; o3 < i3.length; o3++)
      i3[o3] && j(i3[o3], u3, t3 || "function" != typeof n2.type);
...
export {
  ...
  g2 as useId,
  T2 as useImperativeHandle,
  A2 as useLayoutEffect,
  q as useMemo,
  y as useReducer,
  F2 as useRef,
  p2 as useState
