...
import { A as AstroError, c as InvalidImageService, d as ExpectedImageOptions, E as ExpectedImage, F as FailedToFetchRemoteImageDimensions, e as createAstro, f as createComponent, g as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, h as addAttribute, s as spreadAttributes, i as createTransitionScope, j as renderComponent, k as renderSlot, l as renderTransition, n as renderHead } from '../astro_SLRudV6K.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                             */
/* empty css                          */
import { r as resolveSrc, i as isRemoteImage, a as isESMImportedImage, b as isLocalService, D as DEFAULT_HASH_PROPS } from '../astro/assets-service_ByYqsy_t.mjs';
/* empty css                        */
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../astro/assets-service_ByYqsy_t.mjs'
    ).then(n => n.s).catch((e) => {
...
const $$ThemeIcon = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<button id="themeToggle" data-astro-cid-htzy5xbu${addAttribute(createTransitionScope($$result, "j2vkbfoz"), "data-astro-transition-persist")}> <svg width="30px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-astro-cid-htzy5xbu> <path class="sun" fill-rule="evenodd" d="M12 17.5a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11zm0 1.5a7 7 0 1 0 0-14 7 7 0 0 0 0 14zm12-7a.8.8 0 0 1-.8.8h-2.4a.8.8 0 0 1 0-1.6h2.4a.8.8 0 0 1 .8.8zM4 12a.8.8 0 0 1-.8.8H.8a.8.8 0 0 1 0-1.6h2.5a.8.8 0 0 1 .8.8zm16.5-8.5a.8.8 0 0 1 0 1l-1.8 1.8a.8.8 0 0 1-1-1l1.7-1.8a.8.8 0 0 1 1 0zM6.3 17.7a.8.8 0 0 1 0 1l-1.7 1.8a.8.8 0 1 1-1-1l1.7-1.8a.8.8 0 0 1 1 0zM12 0a.8.8 0 0 1 .8.8v2.5a.8.8 0 0 1-1.6 0V.8A.8.8 0 0 1 12 0zm0 20a.8.8 0 0 1 .8.8v2.4a.8.8 0 0 1-1.6 0v-2.4a.8.8 0 0 1 .8-.8zM3.5 3.5a.8.8 0 0 1 1 0l1.8 1.8a.8.8 0 1 1-1 1L3.5 4.6a.8.8 0 0 1 0-1zm14.2 14.2a.8.8 0 0 1 1 0l1.8 1.7a.8.8 0 0 1-1 1l-1.8-1.7a.8.8 0 0 1 0-1z" data-astro-cid-htzy5xbu></path> <path class="moon" fill-rule="evenodd" d="M16.5 6A10.5 10.5 0 0 1 4.7 16.4 8.5 8.5 0 1 0 16.4 4.7l.1 1.3zm-1.7-2a9 9 0 0 1 .2 2 9 9 0 0 1-11 8.8 9.4 9.4 0 0 1-.8-.3c-.4 0-.8.3-.7.7a10 10 0 0 0 .3.8 10 10 0 0 0 9.2 6 10 10 0 0 0 4-19.2 9.7 9.7 0 0 0-.9-.3c-.3-.1-.7.3-.6.7a9 9 0 0 1 .3.8z" data-astro-cid-htzy5xbu></path> </svg> </button>  `;
...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  document.addEventListener("astro:page-load", toggleShowNavMobil, hiddeNavbar);
  document.addEventListener("astro:after-swap",toggleShowNavMobil,hiddeNavbar);
<\/script>`])), maybeRenderHead(), clientData.web_name, headerNavs.map((nav) => renderTemplate`<li data-astro-cid-3ef6ksr2> <a${addAttribute(nav.url, "href")} class="block py-2 capitalize px-3 text-secondary  rounded md:bg-transparent  md:p-0 dark:text-white" aria-current="page" style="    text-transform: capitalize;" data-astro-cid-3ef6ksr2> ${nav.label} </a> </li>`), renderComponent($$result, "ThemeIcon", $$ThemeIcon, { "data-astro-cid-3ef6ksr2": true }));
}, "C:/Users/CASTELL/Documents/GitHub/ASTRO/Unikit-face-supabase/src/components/Header.astro", void 0);
...
}, "C:/Users/CASTELL/Documents/GitHub/ASTRO/Unikit-face-supabase/node_modules/astro/components/ViewTransitions.astro", void 0);
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a$1 || (_a$1 = __template$1(['<html lang="en"', '> <head><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;700&family=Lora:wght@400;700&display=swap"><!-- dark mode  from flobite --><!-- flowbite link --><link href="https://cdnjs.cloudflare.com/ajax/libs/flowbite/2.2.1/flowbite.min.css" rel="stylesheet"><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta', "", '><meta name="google-site-verification" content="fGktjHCQjBR4YHgvqwZHd9gLTJY6134Ws_WQqk2XMX4"><title>', " | ", "</title>", "", "</head> <body> ", ' <main class="mx-auto p-0"> <div', "> ", " </div> ", " ", ' </main> <!-- flowbite scripts --> <!-- <script is:inline src="../path/to/flowbite/dist/flowbite.min.js"><\/script> --> <script src="https://cdnjs.cloudflare.com/ajax/libs/flowbite/2.2.1/flowbite.min.js"><\/script> <script>\n            // On page load or when changing themes, best to add inline in `head` to avoid FOUC\n            if (\n                localStorage.getItem("color-theme") === "dark" ||\n                (!("color-theme" in localStorage) &&\n                    window.matchMedia("(prefers-color-scheme: dark)").matches)\n            ) {\n                document.documentElement.classList.add("dark");\n            } else {\n                document.documentElement.classList.remove("dark");\n            }\n        <\/script> <!-- swiper bundle --> <!-- Add this script tag to your HTML --> <script src="https://unpkg.com/swiper/swiper-bundle.min.js"><\/script> <!-- cliente supabase -->  <!-- or -->  <!-- dark mode from tailwind --> </body></html>'], ['<html lang="en"', '> <head><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;700&family=Lora:wght@400;700&display=swap"><!-- dark mode  from flobite --><!-- flowbite link --><link href="https://cdnjs.cloudflare.com/ajax/libs/flowbite/2.2.1/flowbite.min.css" rel="stylesheet"><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta', "", '><meta name="google-site-verification" content="fGktjHCQjBR4YHgvqwZHd9gLTJY6134Ws_WQqk2XMX4"><title>', " | ", "</title>", "", "</head> <body> ", ' <main class="mx-auto p-0"> <div', "> ", " </div> ", " ", ' </main> <!-- flowbite scripts --> <!-- <script is:inline src="../path/to/flowbite/dist/flowbite.min.js"><\/script> --> <script src="https://cdnjs.cloudflare.com/ajax/libs/flowbite/2.2.1/flowbite.min.js"><\/script> <script>\n            // On page load or when changing themes, best to add inline in \\`head\\` to avoid FOUC\n            if (\n                localStorage.getItem("color-theme") === "dark" ||\n                (!("color-theme" in localStorage) &&\n                    window.matchMedia("(prefers-color-scheme: dark)").matches)\n            ) {\n                document.documentElement.classList.add("dark");\n            } else {\n                document.documentElement.classList.remove("dark");\n            }\n        <\/script> <!-- swiper bundle --> <!-- Add this script tag to your HTML --> <script src="https://unpkg.com/swiper/swiper-bundle.min.js"><\/script> <!-- cliente supabase -->  <!-- or -->  <!-- dark mode from tailwind --> </body></html>'])), addAttribute(renderTransition($$result, "iaqcb4am", "none", ""), "data-astro-transition-scope"), addAttribute(title, "name"), addAttribute(description, "content"), title, subtitle, renderComponent($$result, "ViewTransitions", $$ViewTransitions, {}), renderHead(), renderComponent($$result, "Header", $$Header, {}), addAttribute(renderTransition($$result, "f6ducegj", "slide", ""), "data-astro-transition-scope"), renderSlot($$result, $$slots["default"]), renderComponent($$result, "Footer", $$Footer, {}), renderComponent($$result, "FloatingButtons", $$FloatingButtons, {}));
...
export { $$Layout as $, _404 as _, $$Image as a, clientData as c, getConfiguredImageService as g, imageConfig as i };
